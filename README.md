# Home Assistant Calendar backed Alarm Clock
...
```bash
git clone https://github.com/luckydonald/hoass_calendar-alarm-clock.git my-plugin
cd my-plugin
```
...
hoass_template/
├── custom_components/
│   └── calendar_alarm_clock/       # Python integration
...
│   ├── src/
│   │   ├── CalendarBackedAlarmClockCard.vue  # Main component
